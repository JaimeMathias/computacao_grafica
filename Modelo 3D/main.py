...
def draw_cube_y(altura, comprimento, tamanho, largura, ponto_central, y, image, offset = 0.01):
    tamanho = tamanho / 2.0
    ...
    if (largura > 0):
        verts = [
            ...
            (ponto_1, y + offset, altura + comprimento),
            (ponto_2, y + offset, altura),
            (ponto_2, y + offset, altura + comprimento),
            
            (ponto_1, y + offset + largura, altura),
            (ponto_1, y + offset + largura, altura + comprimento),
            (ponto_2, y + offset + largura, altura),
            (ponto_2, y + offset + largura, altura + comprimento),
        ]
        faces = [
            (0,1,3,2),
            (4,5,7,6),
...
# Porta Principal
centro_porta_principal = (largura_y / 2) / 2
x = largura_x
